...
public class MappedFileQueue {
    ...
    private long flushedWhere = 0; // 刷盘指针
    private long committedWhere = 0; // 提交指针MappedFileQueue
...
```java
    ...
    private Object[] copyMappedFiles(final int reservedMappedFiles) {
        ...
        if (this.mappedFiles.size() <= reservedMappedFiles) { // CopyOnWriteArrayList<MappedFile> mappedFiles
            return null;
        }
